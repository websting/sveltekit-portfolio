  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12">
        <h3>About Me</h3>
        <p class="paragraph">
          Web Development for me started a few years back when I wanted to share
    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <p class="paragraph">
          Today my interests have changed a little and so has the Web
        ...
        <p class="paragraph">
          Hi, my name is Antonio Herrera. I'm a self thought web developer. My
    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        <div class="icons">
          <i class="fa-brands fa-html5 fa-2x" style="color: orange;"></i>
          ...
          <i class="fa-brands fa-react fa-2x" style="color:aqua;"></i>
        </div>
      </div>
    </div>
  </div>
